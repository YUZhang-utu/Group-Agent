...
WORKFLOW_SKILLS = (
    ...
    {"name": "aidd-protein-preparation", "actions": ["protein_fetch", "protein_resolve", "pdb_search", "pdb_fetch", "structure_survey", "structure_diversity", "anchor_recommend", "anchor_design", "guided_funnel", "guided_select"],
