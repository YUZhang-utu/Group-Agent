...
WORKFLOW_SKILLS = (
    {"name": "aidd-3d-search", "actions": ["search_3d", "review_screening", "classify_screening", "full_library_screen", "select_screening", "export_screening", "prepare_docking", "run_docking"],
