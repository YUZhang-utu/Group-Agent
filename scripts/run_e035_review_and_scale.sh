...
OUTPUT=${E035_OUTPUT:-/mnt/local/hand/yuzhang/aidd/e035-review-and-scale/run-100k-parallel-v2}
...
"$AIDD_PY" -m aidd_agent.e035_validation --batch "$BATCH" --e034 "$SOURCE" --output "$OUTPUT" \
  ...
  --scale-workers "${E035_WORKERS:-8}" --scale-chunk-size "${E035_CHUNK_SIZE:-512}" "$@"
