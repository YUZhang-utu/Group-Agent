...
## E036 parallel scheduling — 2026-09-18
Protocol: experiments/E036-parallel-chunks-protocol.md (70beeff). E035 real million equivalence and historical latency gates passed per user report; molecular/pose quality is unresolved. Bounded parallel E035 chunks and finely scheduled whole-index Gaussian/E031 search implemented. Local194tests passed/2dependency skips including spawn/resume/integrity/end-to-end fixture. Workstation throughput and fresh Gaussian query latency pending; unchanged candidate budgets/seed caps/scoring. Run scripts/run_e036_fast_3d.sh, return report.md/json; optional100k serial/parallel stress benchmark in to_human/E036_FAST_3D_RUN.md. No repeat million validation is required merely to consume the already-passed E035 result.
